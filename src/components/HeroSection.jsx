...
const HeroSection = () => {
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20'>
        ...
        <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Empower your creativity and bring out your VR app ideas to life with our intuitive development tools. Get starteed today and turn your imagination into immersive reality.</p>
